...
def main():
    ...
    if is_csv:
        ...
        RCtools.check_dac_units(df)   # hard-fails if VHIGH_TG isn't already in volts
        ...
        # VHIGH_TG is already in volts (tdms_to_fits.py schema >= 2.0.0); round for display
        df[TGKEY] = round(df[TGKEY], 2)
